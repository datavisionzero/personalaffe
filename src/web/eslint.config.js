...
export default defineConfig([
  // The API layer is generated from the contract before every build and is not
  // committed; linting somebody else's output says nothing about this code.
  ...
  {
    // Generated once by the shadcn CLI and owned here (ADR 0001); they export
    ...
    rules: {
      "no-restricted-syntax": [
        "error",
        {
          ...
          message:
            "A form field needs an id (from useId) or a name, or the browser cannot tell it apart.",
        },
      ],
    },
  },
